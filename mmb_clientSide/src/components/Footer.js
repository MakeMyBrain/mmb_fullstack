                ...
                <Container>
                    <Row className="justify-content-md-center text-white">
                        ...
                        <Col sm={3}>
                            <h5>Navigation</h5>
                            <ul >
                                <li><Link to={"/category"} className="text-white text-decoration-none">Mind Tales</Link></li>
                                <li><Link to={"/openup"} className="text-white text-decoration-none">Feel Better</Link></li>
                                <li><Link to={"/about"} className="text-white text-decoration-none">About Us</Link></li>
                                <li><Link to={"/therapist"} className="text-white text-decoration-none">Find Therapist</Link></li>
                            </ul>
                        </Col>
                        <Col sm={3}>
                            <Row >
