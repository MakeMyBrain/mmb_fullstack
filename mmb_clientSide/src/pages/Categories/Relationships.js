  ...
  return (
    <div id='subcategory-container'>
      ...
      <div id='subcategory-list'>
        ...
        <div className='subcategory-items' onClick={() => handleClick('Breakup')}>Breakup</div>
        <div className='subcategory-items' onClick={() => handleClick('Power struggles')}>Power struggles</div>
        <div className='subcategory-items' onClick={() => handleClick('Compatibility with partner')}>Compatibility with partner</div>
        <div className='subcategory-items' onClick={() => handleClick('Incompatible families')}>Incompatible families</div>
        <div className='subcategory-items' onClick={() => handleClick('Not available for each other')}>Not available for each other</div>
