		...
		<div>
			...
			<div>
				<div className="story-head">
					Search student stories by college, name, company, problem
					and more.
				</div>
				<div id={Styles.box}>
					<input
						...
						onChange={(e) => setQueryArray(e.target.value)}
					/>
				</div>
						...
						{query.length > 0
							? Users.filter((user) =>
									...
									<li className={Styles.listItem}>
										<li className={Styles.cardQuote}>
											<i>"{user.quote}"</i>
										</li>
										<li className={Styles.cardName}>
											<br />
											{user.name}
										</li>
										<li className={Styles.cardDesc}>
											{user.company}
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											{user.mode}
										</li>
